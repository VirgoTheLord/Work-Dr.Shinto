...
const Hero = () => {
    ...
    if (
      ...
      tl.from(subtitleRef.current, {
        ...
        .from(
          ...
          "-=0.6" // Adjusted overlap for a sequential animation
        )
        .from(
  ...
  return (
    <div className="min-h-screen relative w-full flex flex-col justify-center items-start px-6 md:px-10 pt-20 pb-32 sm:py-20 overflow-hidden">
